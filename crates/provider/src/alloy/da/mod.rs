...
#[cfg(test)]
mod tests {
    use alloy_primitives::{Address, U256, address, b256, bytes, uint};
    ...
    fn test_uo_data_1() -> Bytes {
        let puo = PackedUserOperation {
            ...
            callData: bytes!(
                ""
            ),
            ...
            signature: bytes!(
                "0b83faeeac250d4c4a2459c1d6e1f8427f96af246d7fb3027b10bb05d934912f23a9491c16ab97ab32ac88179f279e871387c23547aa2e27b83fc358058e71fa1c"
            ),
        };
        puo.abi_encode().into()
    }
