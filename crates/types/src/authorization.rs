...
impl Eip7702Auth {
    /// Create a dummy Eip7702Auth entity.
    pub fn new_dummy(chain_id: u64, address: Address) -> Eip7702Auth {
        Self {
            inner: SignedAuthorization::new_unchecked(
                Authorization {
    ...
    pub fn new_random_fill(chain_id: u64, address: Address) -> Eip7702Auth {
        Self {
            inner: SignedAuthorization::new_unchecked(
                Authorization {
                    chain_id: U256::from(chain_id),
    ...
    pub fn new_max_fill(chain_id: u64, address: Address) -> Eip7702Auth {
        Self::new_max_fill_inner(U256::from(chain_id), address)
    }
    ...
    /// Convert into a max filled Eip7702Auth entity.
    pub fn into_max_fill(self) -> Eip7702Auth {
        Self::new_max_fill_inner(self.chain_id, self.address)
    }

    fn new_max_fill_inner(chain_id: U256, address: Address) -> Eip7702Auth {
        Self {
            inner: SignedAuthorization::new_unchecked(
                Authorization {
                    chain_id,
