...
// impl<T, R, RE> Clone for MetricsLayer<T, R, RE>
// where
//     T: RequestExtractor<R>,
// {
//     fn clone(&self) -> Self {
...
// impl<S, T, R, RE> Clone for MetricsMiddleware<S, T, R, RE>
// where
//     S: Clone,
// {
//     fn clone(&self) -> Self {
...
// impl<S, T, R, RE> Service<R> for MetricsMiddleware<S, T, R, RE>
// where
//     S: Service<R> + Send + Sync + Clone + 'static,
...
//         metrics::counter!("http_response_status", "method_name" => method_name.to_string(), "service_name" => service_name.to_string(), "protocol" => "http", "response_code" => http_status_code.to_string()).increment(1)
//     }

//     fn increment_rpc_response_code(method_name: &str, service_name: &str, rpc_status_code: &str) {
//         metrics::counter!("rpc_response_status", "method_name" => method_name.to_string(), "service_name" => service_name.to_string(), "protocol" => "rpc", "response_code" => rpc_status_code.to_string()).increment(1)
//     }
